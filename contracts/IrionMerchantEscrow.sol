...
/**
 * @title IrionMerchantEscrow
 * @dev A simple escrow contract for merchants to receive payments from the Irion protocol.
 * The deployed address acts as theMerchant ID / API Key.
 */
contract IrionMerchantEscrow {
    ...
    /**
     * @dev Called by the Irion Protocol (user wallet/contract) to settle a credit payment.
